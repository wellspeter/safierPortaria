...
const routes: Routes = [
 ...
 
  {
    ...
    children: [
      ...
      {
        path: "portaria",
        loadChildren: () => import('./pages/portaria/portaria.module').then(x=>x.PortariaModule)
      },
      {
        path: "cadmorador",
        loadChildren: () => import('./pages/morador/cadastro/morador-cadastro.module').then(x=>x.CadastroMoradorModule)
      },
      {
        path: "components",
